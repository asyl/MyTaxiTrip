...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
  ...
  AITripListViewController *tripController = (AITripListViewController *)navigationController.topViewController;
  tripController.viewModel = [[AITripListViewModel alloc] initWithModel:[AICoreDataStack defaultStack].managedObjectContext];
  
  //Setup model
  [[AICoreDataStack defaultStack] ensureInitialLoad];
  return YES;
}
